...
La solución se dirige a dos segmentos con roles diferenciados dentro del mismo dominio: quien conduce la parcela y quien la asesora técnicamente.

### Segmento 1: Pequeños y medianos productores agropecuarios de la costa norte

Es el pequeño y mediano productor que conduce unidades menores a cinco hectáreas, el **81,9 %** de los 2 260 973 productores agropecuarios registrados en el Perú (INEI, IV CENAGRO). El foco inicial se ubica en la costa norte —valles de Piura y Lambayeque— por la severidad documentada de la salinización en los sistemas Chira-Piura y Chancay-Lambayeque.

Tiene en promedio **54,5 años** de edad y educación mayoritariamente primaria (**57,7 %**). Solo el **8 %** accede a crédito formal, pero el acceso a internet vía móvil llega al **85,8 %** en zonas rurales, lo que confirma que la solución debe ser mobile-first. Apenas el **2,5 %** realiza análisis de suelo y el **14,9 %** usa riego tecnificado, evidenciando la ausencia de monitoreo continuo.

**Perfil resumido:** hombre de alrededor de 55 años, con educación primaria, que conduce menos de cinco hectáreas de arroz o maíz en Piura o Lambayeque y nunca ha hecho un análisis de suelo.

### Segmento 2: Ingenieros agrónomos y asesores técnicos agrícolas independientes

Es el ingeniero agrónomo o asesor técnico que atiende de forma independiente a varios productores mediante visitas periódicas, lo que hace del desplazamiento su principal costo operativo. El Colegio de Ingenieros del Perú (Consejo de Lima) registra alrededor de **6 000 profesionales** de esta especialidad.

Hoy combina el análisis de laboratorio, medidores portátiles de conductividad eléctrica y su propio criterio agronómico, ya que las plataformas de agricultura de precisión se dirigen casi exclusivamente a clientes agroexportadores. Programas estatales como AGROIDEAS, AGRO RURAL e INIA reconocen que la cobertura de extensión agraria pública es desigual, dejando al asesor independiente como actor clave para cerrar esa brecha.

**Perfil resumido:** ingeniero agrónomo colegiado, de 30 a 45 años, que cobra por visita o servicio de asesoría e interpreta sin dificultad una lectura en dS/m.

### Justificación de la selección de ambos segmentos

Ambos segmentos se eligen en conjunto porque cumplen roles distintos: el productor opera la parcela pero enfrenta una limitación de pago (solo el 8 % accede a crédito formal), mientras que el asesor cobra por su servicio profesional, puede internalizar el costo de la herramienta y actúa como canal de distribución que reduce la barrera de desconfianza hacia un dispositivo de bajo costo.
