...
|---|---|---|---|
| <img src="../assets/members/Iker_Barturen.png" alt="Barturen Panez, Iker Gabriel" width="120"> | Barturen Panez, Iker Gabriel | u202312629 | Estudiante de Ingeniería de Software en la UPC. Aporta conocimientos de control de versiones con Git y GitHub, que aplicó al estructurar el repositorio del informe y el flujo de ramas del equipo, y de Domain-Driven Design táctico, con el que documentó las capas de los bounded contexts. Destaca por su capacidad de organización y de integración del trabajo del equipo. |
| <img src="../assets/members/Alexis_Encalada.jpeg" alt="Encalada Salazar, Alexis" width="120"> | Encalada Salazar, Alexis | u20211g481 | Estudiante de Ingeniería de Software en la UPC. Aporta conocimientos de investigación de usuarios, que aplicó al diseñar la guía de entrevistas de needfinding para ambos segmentos, y de análisis de necesidades para convertir los hallazgos en requisitos del producto. Destaca por su comunicación con los entrevistados y su capacidad de síntesis. |
| <img src="../assets/members/Esther_Gone.png" alt="Goñe Araccata, Esther Abigail" width="120"> | Goñe Araccata, Esther Abigail | u202318049 | Estudiante de Ingeniería de Software en la UPC. Aporta conocimientos de diseño de experiencia de usuario con UXPressia, que aplicó en la elaboración de los User Personas, los User Journey Maps y el Impact Mapping. Destaca por su enfoque empático y su cuidado en la organización de los artefactos del proyecto. |
| <img src="../assets/members/Victor_Ortiz.jpeg" alt="Ortiz Alarcon, Victor Nicolas" width="120"> | Ortiz Alarcon, Victor Nicolas | u202312899 | Estudiante de Ingeniería de Software en la UPC. Aporta conocimientos de Lean UX, que aplicó al ajustar los Hypothesis Statements a lo solicitado por el enunciado, y de documentación técnica en Markdown para la estructura del informe. Destaca por su atención al detalle y su disposición a revisar y corregir el trabajo del equipo. |
| <img src="../assets/members/Alvaro_Salazar.jpg" alt="Salazar Caballero, Alvaro Fabrizzio" width="120"> | Salazar Caballero, Alvaro Fabrizzio | u202321941 | Estudiante de Ingeniería de Software en la UPC. Aporta habilidades de investigación y análisis de información, que aplicó en la técnica 5W+2H y en el sustento estadístico de los segmentos objetivo, y conocimientos del proceso Lean UX para consolidar el Lean UX Canvas. Destaca por su rigor para buscar y contrastar fuentes. |
| <img src="../assets/members/Andreow_Santiago.jpeg" alt="Santiago Peña, Andreow Jomark" width="120"> | Santiago Peña, Andreow Jomark | u202317362 | Estudiante de Ingeniería de Software en la UPC. Aporta conocimientos de Domain-Driven Design estratégico, que aplicó al facilitar las sesiones de EventStorming, el Candidate Context Discovery y los Bounded Context Canvases, y de gestión de requisitos ágiles con épicas, User Stories y Product Backlog en Trello. Destaca por su capacidad para modelar el dominio y coordinar sesiones colaborativas. |
| <img src="../assets/members/Manuel_Tumi.png" alt="Tumi Oliden, Manuel Ignacio" width="120"> | Tumi Oliden, Manuel Ignacio | u20241c134 | Estudiante de Ingeniería de Software en la UPC. Aporta conocimientos de modelado de software con UML y del C4 Model, que aplicó en los diagramas y vistas de arquitectura, y de investigación del producto para definir criterios de diseño. Destaca por su pensamiento analítico y su visión de la arquitectura de la solución. |
...
El Ministerio de Desarrollo Agrario y Riego estima que **al menos el 40 % de los suelos agrícolas de la costa está afectado por procesos de salinización y mal drenaje** (MIDAGRI, s.f.). El referente histórico más citado, elaborado por la Oficina Nacional de Evaluación de Recursos Naturales (ONERN), estimó cerca de **300 000 hectáreas con problemas de drenaje y salinización** a lo largo de la zona costera (Aimituma-Franco et al., 2023). Estimaciones posteriores del INRENA situaron las superficies salinas de la costa en torno a las **306 701 hectáreas** (INRENA, 2005, citado en Rocha-Yupanqui y Gomero, 2019).
...
La evidencia académica documenta casos concretos con superficie medida. En el valle bajo del río Santa, en Áncash, se registraron entre 1973 y 2008 suelos con salinidad alta y muy alta en el 5,16 % y el 31,96 % del área evaluada respectivamente, con **712,86 hectáreas** de superficie agrícola dañada (Campoverde, 2012). En los distritos limeños de San Antonio y Mala se documentó la **pérdida de 1 690,47 hectáreas** de tierra cultivable por salinización entre 1976 y 2016, con deterioro en la mayoría de los puntos de muestreo (Quezada, 2020).
...
El propio Estado reconoce que el diagnóstico disponible está desactualizado: los datos base provienen de la ONERN de la década de 1970 y las evaluaciones oficiales señalan que la situación actual es probablemente más severa. Existe además un antecedente legislativo, el **Proyecto de Ley 7786/2020-CR** (Congreso de la República del Perú, 2020), que declara de interés nacional la prevención de la salinización del suelo agrícola, señal de que el problema está reconocido en la agenda pública pero sin instrumento de medición continua que lo respalde.
...
Afecta a los **2 260 973 productores agropecuarios** del país, de los cuales el **81,8 % conduce unidades de hasta cinco hectáreas** (INEI, 2013). Este segmento tiene una edad promedio de **54,5 años** y un nivel educativo mayoritariamente primario (**57,7 %**) (INEI, 2026), rasgos que condicionan directamente cómo debe presentarse la información técnica.

Junto al productor, el problema alcanza a un segundo actor: el **ingeniero agrónomo y asesor técnico independiente**, del que el Colegio de Ingenieros del Perú (Consejo de Lima) registra alrededor de **6 000 profesionales** en la especialidad (CIP-CD Lima, s.f.). Es quien interpreta el dato agronómico y sustenta la recomendación, pero trabaja mediante visitas periódicas, de modo que su capacidad de seguimiento está limitada por el desplazamiento físico.
...
La detección formal exige un análisis de laboratorio. Los laboratorios de referencia son el LASPAF de la Universidad Nacional Agraria La Molina y la red LABSAF del INIA, que cuenta con 179 métodos acreditados por INACAL (MIDAGRI, 2026). Aun así, el resultado es puntual y demora: los entrevistados del Capítulo II esperan hasta dos semanas o más por cada informe. Cada análisis tiene un costo por muestra que el productor debe asumir en cada campaña: uno de los productores entrevistados en el Capítulo II paga alrededor de **S/ 250 por análisis**, y uno de los asesores indicó que una muestra puede costar desde unos **USD 80** según la complejidad del análisis.
...
*En acceso al diagnóstico.* **Solo el 2,5 % de los pequeños y medianos productores realiza análisis de suelo de sus parcelas** (INEI, s.f.). El 97,5 % restante gestiona su suelo a ciegas.

*En costo de la alternativa tecnológica.* Las sondas de las plataformas comerciales de agricultura de precisión se ubican entre **USD 600 y USD 899 por unidad**, más una suscripción anual de USD 275 por sensor (The Spoon, 2018), o en **USD 500 por sonda al año** en modelos de servicio (The Western Producer, 2020), lo que las sitúa fuera del alcance del segmento objetivo por al menos un orden de magnitud.

*En capacidad de respuesta.* **Solo alrededor del 8 % de los productores agropecuarios accede a crédito en el sistema financiero formal** (INEI, 2013), lo que limita severamente su margen para invertir en soluciones correctivas o preventivas una vez detectado el problema.

*En capacidad de recepción.* Frente a todo lo anterior, **el 85,8 % de los hogares rurales ya accede a internet y el 97,2 % de los hogares del país posee al menos un dispositivo móvil para conectarse** (OSIPTEL, 2026), lo que demuestra que el canal para entregar la información ya existe y está instalado; lo que falta es el instrumento asequible que la genere.
...
**Tamaño del universo.** El IV Censo Nacional Agropecuario registró **2 260 973 productores agropecuarios** en el Perú, que ocupan 38 742 465 hectáreas de superficie total y aproximadamente 7,1 millones de hectáreas de superficie agrícola (INEI, 2013). De ese universo, el **81,8 % conduce unidades de hasta cinco hectáreas**, condición que define a la pequeña agricultura (INEI, 2013).

**Distribución territorial.** Sesenta y cuatro de cada cien productores se ubican en la sierra, y los departamentos de Cajamarca, Puno y Cusco concentran el mayor número de productores (INEI, 2013). El foco inicial de la solución, sin embargo, se sitúa en la costa norte por dos razones convergentes: la severidad documentada del problema de salinización en los sistemas Chira-Piura y Chancay-Lambayeque, señalados por MIDAGRI como los más comprometidos por mal drenaje y manejo del riego (MIDAGRI, s.f.); y la coincidencia geográfica con los cultivos de mayor extensión de la región, como el arroz, con **57 545 hectáreas sembradas en Piura** durante la campaña 2024-2025 (Dirección Regional de Agricultura Piura, 2025), un cultivo sensible a la salinidad.

**Perfil demográfico.** Según la Encuesta Nacional Agropecuaria 2025, el productor agropecuario peruano tiene una **edad promedio de 54,5 años**, con una tendencia sostenida al envejecimiento: 53,9 años en 2023 y 54,3 en 2024. En cuanto a género, el **31,2 % son mujeres y el 68,8 % hombres**, con una participación femenina en descenso. El nivel educativo es determinante para el diseño de la interfaz: el **57,7 % alcanzó únicamente educación primaria**, el 32,9 % secundaria y solo el 9,4 % educación superior (INEI, 2026).

**Situación económica y capacidad de pago.** En 2020, la pobreza monetaria afectó al **45,7 % de la población del área rural**, 4,9 puntos porcentuales más que en 2019 (INEI, 2021). El acceso al financiamiento formal constituye la restricción más severa del segmento: **solo alrededor del 8 % de los productores —unos 186 mil— accede a crédito en el sistema financiero nacional** (INEI, 2013), lo que equivale a decir que más del 91 % de las unidades agropecuarias no accede a financiamiento formal. Este dato impone una restricción directa al modelo de negocio: cualquier desembolso inicial significativo excluye al grueso del segmento.

**Adopción tecnológica.** Aquí el panorama es favorable y contraintuitivo. El **97,2 % de los hogares peruanos cuenta con al menos un dispositivo móvil**, y el acceso a internet mediante dispositivo móvil en el ámbito rural pasó del 41,5 % en 2019 al **85,8 % en 2025** (OSIPTEL, 2026). Además, el **88 % de los hogares rurales dispone de al menos un celular** (INEI, 2025). La implicación de diseño es inequívoca: la solución debe concebirse como *mobile-first* y operar sobre datos móviles con tolerancia a la intermitencia, no sobre banda ancha fija.

**Prácticas actuales.** Solo el **14,9 % de los pequeños y medianos productores bajo riego emplea riego tecnificado**, frente al 56,5 % de los grandes productores. Únicamente el **2,5 % realiza análisis de suelo** de sus parcelas. El 44,2 % de quienes venden su producción a grandes productores recibe de estos algún tipo de asistencia técnica o capacitación (INEI, s.f.), lo que confirma que la vía de acceso al conocimiento agronómico es indirecta y depende de terceros.
